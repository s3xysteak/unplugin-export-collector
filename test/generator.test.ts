...
`
    ...
    await expGenerator('./test/parser-lab/generatorTest-resolvers.ts', {
      include: ['custom'],
      exclude: ['one'],
      type: 'resolvers',
    })
...
`
    ...
    await expGenerator('./test/parser-lab/generatorTest-resolvers.js', {
      include: ['custom'],
      exclude: ['one'],
      typescript: false,
      type: 'resolvers',
...
`
    ...
    await expGenerator('./test/parser-lab/generatorTest.ts', {
      include: ['custom'],
      exclude: ['one'],
      writeTo: './test/parser-lab/generatorTestWithWriteTo',
    })
